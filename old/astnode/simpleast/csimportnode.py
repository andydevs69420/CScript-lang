...
from astnode.globalast.csAst import CSToken, CSAst, show_error
...
class ImportNode(CSAst):
    ...
    def compile(self, _block:CodeBlock):
        ...
        if  _block.symbtable.current.existsglobally(_name):
            return show_error("duplicate import", self.location)
